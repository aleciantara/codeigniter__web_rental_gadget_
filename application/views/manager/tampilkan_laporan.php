<div class="main-content">
    ...
    <form method="POST" action="<?php echo  base_url('manager/laporan') ?>">
    ...
    <div class="table-responsive mt-3">
		...
		<hr>
		<div class="btn-group">
			<a class="btn btn-sm btn-success"  target="_blank" href="<?php echo base_url().'manager/laporan/print_laporan/? dari='.set_value('dari').'&sampai='.set_value('sampai') ?>"><i class="fas fa-print"></i>Print<a/>
		<div>
	</div>
