<div class="main-content">
    ...
    <?php foreach($transaksi as $tr): ?>
        <form method="POST" action="<?php echo base_url('admin/data_transaksi/transaksi_selesai_aksi')?>">
            ...
            <input type="hidden" name="id_gadget" value="<?php echo $tr->id_gadget?>">
            ...
            <div class="form-group">
                ...
                <input type="date" name="tanggal_pengembalian" class="form-control" value="<?php echo $tr->tanggal_pengembalian?>"><?php echo $tr->tanggal_pengembalian?>
            </div>
